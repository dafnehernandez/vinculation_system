    ...
    <div class="register-box-body">
        ...
        <form method="post" action="<?php echo e(url('/register')); ?>">
            ...
            <div class="form-group has-feedback<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nombre completo">
...
<?php /**PATH /opt/lampp/htdocs/vinculation_system/resources/views/auth/register.blade.php ENDPATH**/ ?>