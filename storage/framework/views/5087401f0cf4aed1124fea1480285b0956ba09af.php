...
<div class="register-box">
    <div class="register-logo">
        <a href="<?php echo e(url('/home')); ?>"><b>Vinculation System</b></a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="<?php echo e(url('/register')); ?>">
            ...
            <div class="form-group has-feedback<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nombre (apareces así en la página)">
              ...
              <div class="form-group has-feedback<?php echo e($errors->has('celular') ? ' has-error' : ''); ?>">
            ...
            <input type="hidden" id="rol_id" name="rol_id" value="4">
        ...
        <a href="<?php echo e(url('/login')); ?>" class="text-center">Ya tengo una cuenta</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
...
<?php /**PATH /opt/lampp/htdocs/vinculation_system/resources/views/registros/register-alumno.blade.php ENDPATH**/ ?>