                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-hover table-responsive" id="routes-table">
                                ...
                                <th>URL</th>
                                <th>Methods</th>
                                <?php if(config('infyom.routes_explorer.collections.api_calls_count')): ?>
                                    <th>Count</th>
                                <?php endif; ?>
                                </thead>
                                <tbody>
...
</html><?php /**PATH /opt/lampp/htdocs/vinculation_system/vendor/infyomlabs/routes-explorer/views/routes.blade.php ENDPATH**/ ?>